...
//by Gamehu 获取对应的queue by ObjectID

Queue.prototype.getQueueByOid = function(params,callback) {
    var self = this
    var query =params;
//   var fields={ sort: sort, returnOriginal : false };
    //建立索引
    self.col.ensureIndex({"clientReference":1,priority:-1});//索引
...
//by Gamehu 获取对应的queue by clientReference

Queue.prototype.getQueuesByCid = function(params,callback) {
    var self = this
    var query =params;
//   var fields={ sort: sort, returnOriginal : false };
    //建立索引
